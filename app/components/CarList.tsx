  ...
  const fetchCars = async (page: string, order: string | null) => {
    ...
    try {
      ...
      const totalPages =
        ...
        (data.meta?.total ? Math.ceil(data.meta.total / 12) : Math.ceil(1897 / 12))
    ...
    <div className="container mx-auto p-4 bg-gray-900 text-white min-h-screen">
          ...
          >
            <div className="w-full flex rounded-t overflow-hidden">
              <Image
                ...
                loading={
                  meta.currentPage === 1 && cars.indexOf(car) < 3 ? undefined : "lazy"
                }
                onError={(e) => {
            ...
            <div className="bg-[rgb(50_41_7)] p-2 rounded-b">
              ...
              <div className="flex justify-between items-center">
                <p className="text-white bg-red-700 px-2 py-1 rounded">${car.price}</p>
      ...
      <div className="mt-6 flex justify-center items-center">
        ...
        <span className="mx-4 text-gray-300">
          Page {meta.currentPage} из {meta.totalPages}
        </span>
        <button
          onClick={() => handlePageChange(meta.currentPage! + 1)}
          disabled={meta.currentPage === meta.totalPages && meta.totalPages === 1}
